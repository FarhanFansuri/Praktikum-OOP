...
public class aritmatika extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hitungGroup = new javax.swing.ButtonGroup();
        ...
        labelt.setText("Tinggi");

        jLabel3.setText("Mochammad Farhan Fansuri");

        jLabel4.setText("123200127");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(labelt, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(labell, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lebar, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(labelp, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(luas, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
        int panjang_input = parseInt(panjang.getText());
        int lebar_input = parseInt(lebar.getText());
        int tinggi_input = parseInt(tinggi.getText());
         if(luas.isSelected()){
            hasil.setText(String.valueOf(panjang_input * lebar_input * tinggi_input));
        }else if(volume.isSelected()){
            hasil.setText(String.valueOf(2 *(
                    panjang_input * lebar_input + 
                    panjang_input * tinggi_input + 
                    lebar_input * tinggi_input)
            ));
        }else{
            JOptionPane.showMessageDialog(rootPane, "Pilih Opsi");
        }
        
        }catch(Exception e){
            hasil.setText("");
            JOptionPane.showMessageDialog(rootPane, "Masukan Nilai dengan Benar");
        }
    ...
    private javax.swing.ButtonGroup hitungGroup;
